...
func (x *PaymentMessage) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PaymentMessage) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *PaymentMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PaymentMessage) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *PaymentMessage) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *ProcessPaymentRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_payment_payment_proto_rawDesc = []byte{
	...
	0x22, 0x7f, 0x0a, 0x0e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x73, 0x22, 0x76, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x61, 0x79, 0x6d,
	...
	0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x32, 0x0a, 0x15, 0x47, 0x65, 0x74,
	...
	,
...
var file_payment_payment_proto_goTypes = []interface{}{
	(*PaymentMessage)(nil),        // 0: payment.PaymentMessage
	(*ProcessPaymentRequest)(nil), // 1: payment.ProcessPaymentRequest
	(*GetPaymentInfoRequest)(nil), // 2: payment.GetPaymentInfoRequest
}
var file_payment_payment_proto_depIdxs = []int32{
	1, // 0: payment.Payment.ProcessPayment:input_type -> payment.ProcessPaymentRequest
	2, // 1: payment.Payment.GetPaymentInfo:input_type -> payment.GetPaymentInfoRequest
	0, // 2: payment.Payment.ProcessPayment:output_type -> payment.PaymentMessage
	0, // 3: payment.Payment.GetPaymentInfo:output_type -> payment.PaymentMessage
